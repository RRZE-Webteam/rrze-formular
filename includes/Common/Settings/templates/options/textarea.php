...
<tr valign="top">
    ...
    <td class="rrze-wp-form rrze-wp-form-input"<?php echo $option->getTourDataAttribute(); ?>>
        <textarea name="<?php echo esc_attr($option->getNameAttribute()); ?>" id="<?php echo esc_attr($option->getIdAttribute()); ?>" <?php echo $option->getInputClassAttribute(); ?>><?php echo esc_textarea((string) ($option->getValueAttribute() ?? '')); ?></textarea>
