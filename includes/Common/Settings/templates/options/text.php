...
<tr valign="top">
    ...
    <td class="rrze-wp-form rrze-wp-form-input"<?php echo $option->getTourDataAttribute(); ?>>
        <input name="<?php echo esc_attr($option->getNameAttribute()); ?>" id="<?php echo esc_attr($option->getIdAttribute()); ?>" type="text" value="<?php echo esc_attr((string) ($option->getValueAttribute() ?? '')); ?>" synonym="<?php echo esc_attr((string) ($option->getsynonymAttribute() ?? '')); ?>" <?php echo $option->getInputClassAttribute(); ?>>
